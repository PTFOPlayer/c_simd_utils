...
int32_t sum32_avx(int32_t *start, int32_t *end)
{
    int64_t len = end - start;
    ...
    int32_t sum =
        _mm256_extract_epi32(accumulator, 0) +
...
int64_t sum64_avx(int64_t *start, int64_t *end)
{
    int64_t len = end - start;
    ...
    int64_t sum =
        _mm256_extract_epi64(accumulator, 0) +
